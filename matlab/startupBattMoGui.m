function result = startupBattMoGui()
    ...
    dirnames = {'Battery', 'Electrochemistry', 'Examples', 'ParameterData', 'Physics', 'Utilities', 'Tests', 'Electrolyser'};
    ...
    if mrstPlatform('octave')
        ...
        run(fullfile(rootdirname, 'MRST', 'mrst-core', 'utils', 'octave_only', 'startup_octave.m'));
