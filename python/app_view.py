...
from app_model import OptionsParameter, NumbericalParameter, BooleanParameter
    ...
    def render_form(self):       
        ...
        with st.form(self.label):
            ...
            for param_key, param_value in self.default_parameters.items():
                ...
                if isinstance(param_value, NumbericalParameter):

                    widget_input = st.number_input(label=param_key, 
                    ...
                    widget_input =  st.selectbox(label=param_key, 
                    ...
                    widget_input =  st.checkbox(label=param_key, 
                                                value=param_value.default, 
                                                key=self.label + "_" + param_key)
...
class SubmitJob:
    ...
    def render_submit_btn(self):
        ...
        st.download_button(label="Save Input parameters",
