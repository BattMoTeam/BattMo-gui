...
class UpdateParameterSets:
    ...
    def update_parameter_set_from_json(self, parameter_set, path, component=None):
        ...
        assert name is not None, "Name of parameter_set {} must have a name".format(
            path
        )
        # assert component is not None, "component of parameter_set {} is not defined".format(name)
        assert (
            parameters is not None
        ), "Parameters of parameter_set {} is not defined".format(name)
        ...
        for model_name in model_names:
            ...
            if material == True:
                ...
                material_id = np.squeeze(
                    db_helper.get_material_id_by_parameter_set_name_and_model_name(
                        name, model_name
                    )
                ).astype(str)
    ...
    def create_or_update_parameter_set(
        self, name, component_id, material, model_name, material_id
    ):
        ...
        if name == "P2D":
            ...
            parameter_set_id = (
                self.sql_parameter_set.get_id_by_name_and_category_and_model_name(
    ...
    def format_parameters(
        ...
        try:
            ...
            template_name = (
                self.sql_model.get_default_template_name_by_name_and_model_name(
        ...
        raw_template_parameters = (
            self.sql_template_parameter.get_id_name_and_type_by_template_id(
    ...
    def delete_parameter_set_by_id(self, parameter_set_id):
        ...
        if parameter_set:
            ...
            parameter_ids = self.sql_parameter.get_all_ids_by_parameter_set_id(
                parameter_set_id
            )
