        ...
        for material_name in materials:
            ...
            for model_name in model_names:
                ...
                if number_of_components == 2:
                    ...
                    component_id_1 = self.sql_component.get_id_from_name(
                        component_name_1
                    )
                    component_id_2 = self.sql_component.get_id_from_name(
                        component_name_2
                    )
                    ...
                    if component_id_1 and component_id_2:
                        ...
                        material_id = self.sql_material.get_id_from_name_and_model_name(
