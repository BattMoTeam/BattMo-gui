module runP2DBattery
    ...
    using BattMo, Logging, JLD2

    export runP2DBatt

    function runP2DBatt(json_file, output_path)
        log_messages = String[]
        log_buffer = nothing
        number_of_states = 0 
        cell_voltage = 0
        ...
        try
            ...
            states, reports, extra = run_battery(json_file, extra_timing = false, output_path=output_path);
